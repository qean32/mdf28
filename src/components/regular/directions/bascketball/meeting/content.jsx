    ...
    return (
        <>
                ...
                <>
                    <div className={styles.content}>
                        <div className={styles.header}>
                            ...
                            <div><p onClick={() => navigate(`/bascketball/team/${match?.team_one?.id}`)} style={{ transition: '.7s' }}>{match.team_one?.team_name} </p><div onClick={() => navigate(`/bascketball/team/${match?.team_one?.id}`)} className={styles.ava} style={{ backgroundImage: `url(${match.team_one?.logo})`, marginRight: '0' }}></div>  </div>
                            ...
                            <div><p onClick={() => navigate(`/bascketball/team/${match?.team_two?.id}`)} style={{ transition: '.7s' }}> {match.team_two?.team_name} </p> <div onClick={() => navigate(`/bascketball/team/${match?.team_two?.id}`)} className={styles.ava} style={{ backgroundImage: `url(${match.team_two?.logo})`, marginRight: '0' }}></div>  </div>
                        </div>
            ...
            {!match.team_one && <div className={styles.content}>
                <img src="/svg/long_arrow.svg" id={styles.id_04} onClick={() => navigate('/bascketball/meetings')} />
