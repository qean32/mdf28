...
const Content = () => {
    ...
    let SearhUser = async (id) => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/search/tournament/?id=${id}`, {
            method: 'GET',
            headers: {
    ...
    let SearhMeeting = async (id) => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/search/meeting/?tournament=${id}&is_qualification=false&limit=20&offset=0`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let SearhMeetingq = async (id) => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/search/meeting/?tournament=${id}&is_qualification=true&limit=20&offset=0`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let SearhOF = async () => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/search/application_tournament/?tournament=${id}&limit=20&offset=0`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let regOF = async () => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/reg/application_tournament/`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
    ...
    let upOF = async (ido) => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/update/application_tournament/${ido}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
    ...
    let uptour = async (idj) => {
        ...
        let response = await fetch(`https://mdf28server.site/api/bascketball/update/tournament_org/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
