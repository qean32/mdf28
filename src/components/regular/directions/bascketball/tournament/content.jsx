...
const Content = () => {
    ...
    let SearhMeeting = async (id) => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/search/meeting/?tournament=${id}&is_qualification=false`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let SearhMeetingq = async (id) => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/search/meeting/?tournament=${id}&is_qualification=true`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let SearhOF = async () => {
        let response = await fetch(`https://mdf28server.site/api/bascketball/search/application_tournament/?tournament=${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
