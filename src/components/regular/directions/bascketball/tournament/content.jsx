...
const Content = () => {
    ...
    let SearhUser = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/search/tournament/?id=${id}`, {
            method: 'GET',
            headers: {
    ...
    let SearhMeeting = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/search/meeting/?tournament=${id}&is_qualification=false`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let SearhMeetingq = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/search/meeting/?tournament=${id}&is_qualification=true`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let SearhOF = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/search/application_tournament/?tournament=${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let SearhuOF = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/search/application_tournament/?tournament=${id}&team=${dir}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let regOF = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/reg/application_tournament/`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
    ...
    let upOF = async (ido) => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/update/application_tournament/${ido}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
    ...
    let uptour = async (idj) => {
        ...
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/update/tournament_org/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
    ...
    let reg = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/bascketball/reg/meeting/`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`,
            ...
            <div className={styles.content}>
                ...
                <div className={styles.body}>
                    <div className={styles.teams}>
                        ...
                        {match && match.teams.map(el => <div className={styles.fight1} onClick={() => navigate(`/bascketball/team/${el.id}`)} style={{ backgroundColor: `${el.color}` }}>
