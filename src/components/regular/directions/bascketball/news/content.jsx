...
const Content = ({ }) => {
    ...
    const [link, setlink] = useState(`${host}/api/news/search/news/?direction=4`)
    ...
    let SearhTournament = async () => {
        let response = await fetch(`${host}/api/${direction}/search/tournament/?limit=1&offset=0`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    return (
        <>
            <div className='agetations'>
                ...
                <img src="/svg/bascketball_logo.svg" id='id_53' />
