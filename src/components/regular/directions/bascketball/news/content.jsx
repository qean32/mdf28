...
const Content = ({ }) => {
    ...
    const [link, setlink] = useState('http://qean32.beget.tech/api/news/search/news/?direction=2')
    ...
    let Searh = async () => {
        let response = await fetch('http://qean32.beget.tech/api/bascketball/search/tournament/?limit=1&offset=0', {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
