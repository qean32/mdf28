...
const Match = ({el}) => {
    ...
    return ( 
        <>
        {el.team_one && el.team_two && <div className={styles.content} onClick={() => navigate(`/bascketball/meeting/${el.id}`)}>
            ...
            <div className={styles.info}>
                    ...
                    {el.is_friends == false && <img src='/mdf28/svg/cup.svg' style={{height:'23px'}}/>}
                    {el.is_friends && <img src='/mdf28/svg/friends.svg' style={{transform: 'translateX(-1px)'}}/>}
                </div>
