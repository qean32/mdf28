...
const Content = () => {
    ...
    let SearchMatch = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/dota/search/match/?meeting=${id}`, {
            method: 'GET',
            headers: {
    ...
    let SearhUser = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/dota/search/meeting/?id=${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let Searchplayer = async (user, set) => {
        let response = await fetch(`http://qean32.beget.tech/api/dota/search/player/?user=${user}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let Searchplayerteam1 = async () => {
        if (match?.team_one?.id) {
            let response = await fetch(`http://qean32.beget.tech/api/dota/search/player/?team=${match?.team_one?.id}&offset=0&limit=16`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    let Searchplayerteam2 = async () => {
        if (match?.team_two?.id) {
            let response = await fetch(`http://qean32.beget.tech/api/dota/search/player/?team=${match?.team_two?.id}&offset=0&limit=16`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const upteam1 = async () => {
        if (selected1.length > 4 && selected1.length < 6) {
            let response = await fetch(`http://qean32.beget.tech/api/dota/update/meeting_director/${id}/`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
    ...
    let upmeeting = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/dota/update/meeting_org/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`,
    ...
    useEffect(() => {
        if (nameP.length <= 1) {
            let SearhPll = async () => {
                let response = await fetch(`http://qean32.beget.tech/api/dota/search/team/?limit=1&offset=0`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    let SearhPl = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/dota/search/team/?search=${nameP}&limit=1&offset=0`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let upmatch = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/dota/update/match_director/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
    ...
    let upmatch_org = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/dota/update/match_org/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
