        ...
        <>
            <div className={styles.content}>
                ...
                <form className={styles.form} onSubmit={(e) => reg(e)}>
                    ...
                    {!Player && <p style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '10px', marginTop:'40px' }}>перед регистристрацией команды вы должны <span onClick={() => navigate('/dota/regplayer')} className={styles.span}>_ стать игроком лиги</span></p>}
