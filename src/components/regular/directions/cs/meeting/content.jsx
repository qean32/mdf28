...
const Content = () => {
    ...
    let SearchMatch = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/cs/search/match/?meeting=${id}`, {
            method: 'GET',
            headers: {
    ...
    let SearhUser = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/cs/search/meeting/?id=${id}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let Searchplayer = async (user, set) => {
        let response = await fetch(`http://qean32.beget.tech/api/cs/search/player/?user=${user}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let Searchplayerteam1 = async () => {
        if (match?.team_one?.id) {
            let response = await fetch(`http://qean32.beget.tech/api/cs/search/player/?team=${match?.team_one?.id}&offset=0&limit=16`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    let Searchplayerteam2 = async () => {
        if (match?.team_two?.id) {
            let response = await fetch(`http://qean32.beget.tech/api/cs/search/player/?team=${match?.team_two?.id}&offset=0&limit=16`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const upteam1 = async () => {
        if (selected1.length > 4 && selected1.length < 6) {
            let response = await fetch(`http://qean32.beget.tech/api/cs/update/meeting_director/${id}/`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
    ...
    let uppl = async (player) => {
        ...
        let response = await fetch(`http://qean32.beget.tech/api/cs/update/player_director/${player.user.id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`,
    ...
    let upteam = async (team) => {
        ...
        let response = await fetch(`http://qean32.beget.tech/api/cs/update_org/team/${team.id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`,
    ...
    let upmeeting = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/cs/update/meeting_org/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`,
    ...
    useEffect(() => {
        if (nameP.length <= 1) {
            let SearhPll = async () => {
                let response = await fetch(`http://qean32.beget.tech/api/cs/search/team/?limit=1&offset=0`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    let SearhPl = async () => {
        let response = await fetch(`http://qean32.beget.tech/api/cs/search/team/?search=${nameP}&limit=1&offset=0`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    let upmatch = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/cs/update/match_director/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
    ...
    let upmatch_org = async (id) => {
        let response = await fetch(`http://qean32.beget.tech/api/cs/update/match_org/${id}/`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `JWT ${JSON.parse(localStorage.getItem('token')).access}`
