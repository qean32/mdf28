    ...
    return (
        <>
            {view ? <div className='full' style={{ justifyContent: 'start', alignItems: 'start', flexDirection: 'column' }}>
                ...
                <img src="/mdf28/svg/dota_logo.svg" id="id_104" onClick={DOTA} className={isDOTA && 'opacity05'} style={{ top: '43%', right: '25%', height: '50px', cursor: 'pointer', transition: '.5s' }} />
                <img src="/mdf28/svg/cs.png" id="id_104" onClick={CS} className={isCS && 'opacity05'} style={{ top: '45%', right: '10%', height: '46px', cursor: 'pointer', transition: '.5s' }} />
                <img src="/mdf28/svg/bascketball_logo.svg" onClick={BASCKETBALL} className={isBASCKETBALL && 'opacity05'} id="id_104" style={{ top: '55%', right: '20%', height: '50px', cursor: 'pointer', transition: '.5s' }} />
                <div className='app_'>
                    <div className='app__'>
