...
const PlayerEdit = ({ el, idteam, host, direction, str_direction }) => {
            ...
            <div className={styles.editplayer}>
                <div>
                    ...
                    <div className={styles.pos} style={{ marginLeft: '50px', marginRight: '10px' }}>
                        ...
                        <label htmlFor="id_1"><img src="/position/pos_3.png" alt="" onClick={() => uppos(pos3, setpos3, 3)} className={pos3 ? styles.bck : {}} style={{ height: '18px', padding: '5px', borderRadius: '7px' }} /></label>
                        <label htmlFor="id_1"><img src="/position/pos_4.png" alt="" onClick={() => uppos(pos4, setpos4, 4)} className={pos4 ? styles.bck : {}} style={{ height: '18px', padding: '5px', borderRadius: '7px' }} /></label>
                        <label htmlFor="id_1"><img src="/position/pos_5.png" alt="" onClick={() => uppos(pos5, setpos5, 5)} className={pos5 ? styles.bck : {}} style={{ height: '18px', padding: '5px', borderRadius: '7px' }} /></label>
                    </div>
                    <div style={{ gap: '10px' }}>
