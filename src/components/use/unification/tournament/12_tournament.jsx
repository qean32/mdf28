...
const Tournament_12 = ({ matches, str_direction }) => {
    return (
        <>
            <div className={styles.grid}>
                ...
                <div className={styles.first}>
                    ...
                    <div className={styles.prev_f}><div className={styles.fight}>
                        ...
                        <Match str_direction={str_direction} match={matches[15]} />
                    </div></div>
                    <div></div>
                </div>
                <div className={styles.first}>
                    ...
                    <div className={styles.prev_f}><div className={styles.fight}>
                        ...
                        <Match str_direction={str_direction} match={matches[16]} />
                    </div></div>
                    <div></div>
                </div>
                <div className={styles.first}>
                    ...
                    <div style={{ transform: 'translateX(55px)' }}><div className={styles.fight}>
                        <Match str_direction={str_direction} match={matches[17]} />
                    </div></div>
                    <div></div>
                </div>
            </div>
