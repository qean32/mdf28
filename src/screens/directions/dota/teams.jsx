...
import Content from '../../../components/regular/directions/dota/teams/content';
                ...
                <main>
                    ...
                    <section  id="s_id"><Right_panel />
                        <div className='content_right_'>
                            <Right_panel_place namee={'создать команду'} navigat={('/dota/regteam')} />
                        </div>
                    </section>
                </main>
