...
const Team_PAGE = () => {
    ...
    let { viewModal, viewShadow, OfModal, RunModal, propsStyle, propsStyle_, host, TitleFUnction } = useContext(context)
        ...
        <>
            {view ? <main>
                ...
                <main>
                    ...
                    <section><Team host={host} direction={direction} str_direction={str_direction} /></section>
