...
const Players_PAGE = () => {
    ...
    let { viewModal, viewShadow, OfModal, RunModal, propsStyle, propsStyle_, host, style_, view, TitleFUnction } = useContext(context) 
        ...
        <>
            {view ? <main>
                ...
                <main>
                    ...
                    <section><Players style_={style_} host={host} direction={direction} str_direction={str_direction} /></section>
