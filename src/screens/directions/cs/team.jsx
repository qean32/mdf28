                ...
                <main>
                    ...
                    <section style={{ transform: 'translateX(50px)', width: '25%' }}><Right_panel />
                        <div className='content_right_'>
                            {user?.user_id == team?.director?.id && <Right_panel_place namee={'редактировать команду'} navigat={(`/cs/editteam/${team.id}`)} />}
                            {user?.user_id == team?.director?.id && <Right_panel_place namee={'редактировать состав'} navigat={(`/cs/editteam/${team.id}`)} />}
